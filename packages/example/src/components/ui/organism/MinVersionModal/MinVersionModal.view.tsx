  ...
  return (
    <Wrapper>
      ...
      <Description>
        ...
        <ul>
          <li>
            Delete the current version in MetaMask by going in Settings {'>'} Snaps {'>'}{' '}
            @consensys/starknet-snap {'>'} See details {'>'} Remove Snap
          </li>
          <li>Refresh the page</li>
          <li>Click on connect, the new version will be proposed for installation.</li>
        </ul>
        Note: Your account will be automatically recovered. Future upgrades will be managed
        automatically
      </Description>
    </Wrapper>
  );
